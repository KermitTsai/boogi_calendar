package com.example.presstest2.event.event_tomorrow;
...
public class EventAdapter_tomorrow extends RecyclerView.Adapter<EventAdapter_tomorrow.EventViewHolder>{
    List<Event_tomorrow> mListEvents;
    private ViewBinderHelper viewBinderHelper =new ViewBinderHelper();

    String[] color ={"red","orange","yellow","teal","green","blue","navy","light_purple"};

    public EventAdapter_tomorrow(List<Event_tomorrow> mListEvents) {
    ...
    public void onBindViewHolder(@NonNull EventViewHolder holder, int position) {
        Event_tomorrow event = mListEvents.get(position);
        if(event ==null){
            return;
        }
